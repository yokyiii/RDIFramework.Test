...
namespace .BizLogic
{
	...
	public class SchoolService : System.MarshalByRefObject, ISchoolService
	{
		private string serviceName = "School";
		...
		#region public string Add(UserInfo userInfo, SchoolEntity entity, out string statusCode, out string statusMessage) 新增
		/// <summary>
		/// 新增
		/// </summary>
		...
		/// <returns>主鍵</returns>
		public string Add(UserInfo userInfo, SchoolEntity entity, out string statusCode, out string statusMessage)
		{
            ...
            {
                var manager = new SchoolManager(dbProvider, userInfo);
		...
		#region public int Update(UserInfo userInfo, SchoolEntity entity, out string statusCode, out string statusMessage) 更新
		/// <summary>
		/// 更新
		/// </summary>
		/// <param name="userInfo">用户</param>
		...
		public int Update(UserInfo userInfo, SchoolEntity entity, out string statusCode, out string statusMessage)
		{
			int returnValue = 0;
            string returnCode = string.Empty;
            string returnMessage = string.Empty;
		...
		{
			var dataTable = new DataTable(SchoolTable.TableName);
            var parameter = ParameterUtil.CreateWithOutMessage(userInfo, MethodBase.GetCurrentMethod(), this.serviceName);

            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                dataTable = new SchoolManager(dbProvider, userInfo).GetDT(SchoolTable.FieldDeleteMark, 0, SchoolTable.FieldCreateOn + " DESC ");
                dataTable.TableName = SchoolTable.TableName;
            });
            return dataTable;
		}
		#endregion
		...
		#region public List<SchoolEntity> GetListByPage(UserInfo userInfo, string searchValue, out int recordCount, int pageIndex = 1, int pageSize = 20, string sortExpression = null) 分页获取列表
        /// <summary>
        /// 分页获取列表
        /// </summary>
        /// <param name="userInfo">用户</param>
        ...
        /// <param name="sortExpression">排序字段</param>
        /// <returns>数据表</returns>
        public List<SchoolEntity> GetListByPage(UserInfo userInfo, string searchValue, out int recordCount, int pageIndex = 1, int pageSize = 20, string sortExpression = null)
        {
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                ...
                list = BaseEntity.GetList<SchoolEntity>(dataTable);
            });
            recordCount = returnRecordCount;
            return list;
        }
		...
		#region public SchoolEntity GetEntity(UserInfo userInfo, string id) 获取实体
		/// <summary>
		/// 得到实体
		/// </summary>
		/// <param name="userInfo">用户</param>
		...
		/// <returns>实体</returns>
		public SchoolEntity GetEntity(UserInfo userInfo, string id)
		{
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                entity = new SchoolManager(dbProvider, userInfo).GetEntity(id);
            });
            return entity;
		}
		#endregion
		...
		public DataTable GetDTByIds(UserInfo userInfo, string[] ids)
		{
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                dataTable = new SchoolManager(dbProvider, userInfo).GetDT(SchoolTable.FieldId, ids, SchoolTable.FieldCreateOn + " DESC ");
                dataTable.TableName = SchoolTable.TableName;
            });
		...
		public DataTable GetDTByValues(UserInfo userInfo, List<KeyValuePair<string, object>> parameters)
		{
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                dataTable = new SchoolManager(dbProvider, userInfo).GetDT(parameters);
                dataTable.TableName = SchoolTable.TableName;
            });
            return dataTable;
		}
		...
		#region public int BatchSave(UserInfo userInfo, List<SchoolEntity> entites) 批量保存数据
		/// <summary>
		/// 批量保存数据
		/// </summary>
		/// <param name="userInfo">用户</param>
		...
		/// <returns>影响行数</returns>
		public int BatchSave(UserInfo userInfo, List<SchoolEntity> entites)
		{
			var returnValue = 0;
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                returnValue += entites.Sum(entity => new SchoolManager(dbProvider, userInfo).Update(entity));
            });
		...
		public int Delete(UserInfo userInfo, string id)
		{
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                returnValue = new SchoolManager(dbProvider, userInfo).Delete(id);
            });
		...
		public int BatchDelete(UserInfo userInfo, string[] ids)
		{
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                returnValue = new SchoolManager(dbProvider, userInfo).Delete(ids);
            });
            return returnValue;
		}
		#endregion
		...
		public int SetDeleted(UserInfo userInfo, string[] ids)
		{
            ...
            ServiceUtil.ProcessBusinessDb(userInfo, parameter, dbProvider =>
            {
                //returnValue = new SchoolManager(dbProvider, userInfo).SetDeleted(ids);
				returnValue = new SchoolManager(dbProvider, userInfo).SetProperty(SchoolTable.FieldId, ids, SchoolTable.FieldDeleteMark, "1");
