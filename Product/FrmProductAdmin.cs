...
namespace RDIFramework.Test
{
    ...
    /// 
    /// 修改记录
    ///     2016-03-16 EricHu V3.0 对产品新增与修改界面做到实体与界面控件的自动绑定与自动获取，减少大量代码。
    ///     2016-01-10 EricHu V3.0 新增在窗体中打开界面时可以在主界面的Tab页中打开（如：增加界面，修改界面等，参考产品管理实例）。
    ///     2014-12-26 王进 V2.8 新新对RDLC报表的打印支持。
    ///     2014-12-15 王进 V2.8 新增按“表约束条件”获取数据。
    ///     2014-09-17 EricHu V2.8 修改按新的分页方式（非存储过程）来进行分页。
    ///     2012-06-17 EricHu 创建“产品管理”。
    /// </summary>
    public partial class FrmProductAdmin : BaseForm
    {
        ...
        {    
            ...
            this.permissionSearch     = this.IsAuthorized("ProductAdmin.Search");
        }
        #endregion
        ...
        public override void SetControlState()
        {
            ...
            else
            {
                ...
                this.btnFind.Enabled     = this.permissionSearch;
            }           
        }
        #endregion
